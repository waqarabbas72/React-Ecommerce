    ...
    return (
        <div className="2xl:mx-auto 2xl:container mx-4 py-16 ">
            <div className="text-center mt-10 lg:mt-24 mb-7">
                <p className="text-rose-800  text-5xl">Subscribe to our Newsletter</p>
            </div>
            <div className=" w-full  relative flex items-center justify-center">
                ...
                <div className="bg-gray-800 bg-opacity-80 md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-10">
