        ...
        <>
            {isAuthenticated ? (
                ...
                <div className="flex items-center justify-center flex-col h-screen gap-10">
                    <p className="text-lg text-red-500"> Please Login First to see the Checkout</p>
                    <Link to={`/`} className="px-5 py-3 bg-gray-800 border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white">Goto HomePage</Link>
                </div >
            )}
        </>
    );
