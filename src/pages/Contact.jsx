                ...
                <div className="w-full 2xl:pl-48 xl:pt-1">
                  ...
                  <div className="w-full md:w-10/12 mt-3">
                    ...
                    <div className="mt-4 md:mt-8">
                      ...
                      <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">79 Sleepy Hollow St. Jamaica, New York 1432</h2>
                    </div>
                    <div className="mt-4 md:mt-8">
                      <h2 className="text-sm md:text-base text-indigo-700 font-semibold">Contact</h2>
                      <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">+670 412 84 722 (Phone)</h2>
                      <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">+670 413 90 762   (Cell)</h2>
                    </div>
                    <div className="mt-4 md:mt-8">
                      <h2 className="text-sm md:text-base text-indigo-700 font-semibold">Email</h2>
                      <h2 className="text-gray-800 text-base md:text-lg leading-8 tracking-wider mt-2">shofy@support.com</h2>
                    </div>
                  </div>
                </div>
              </div>
